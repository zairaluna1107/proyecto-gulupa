...
parser.add_argument('-d', '--direccion',help='Dirección de la carpeta donde se encuentran las imágenes')
parser.add_argument('-a', '--archivo', help='Nombre del archivo CSV')
args = parser.parse_args()

archivo = "{archivo}".format(archivo=args.archivo)
imagesPath = "{direccion}".format(direccion=args.direccion)
...
for imageName in imagesPathList:
  ...
  #OPENING hoja quita puntos blancos fuera de lo segmentado 
	...
	print (datos)
#print('el numero de hojas es:',c)
#print(lista)

x=imutils.featurespixcsv(lista,archivo)
